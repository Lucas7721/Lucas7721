...
<p align="center">
  <strong>Backend Developer com foco em Python, automação, IA aplicada e visão computacional</strong>
</p>

<p align="center">
  Construo ferramentas que automatizam processos, extraem valor de dados e transformam mídia em informação útil.
  <br/>
  Entre backend, scraping, OCR, processamento de vídeo e interfaces web, meu foco é resolver problema real com código simples e funcional.
</p>
...
Sou desenvolvedor com base forte em Python e experiência prática em automação, web scraping, processamento de dados, OCR, IA e visão computacional.

Tenho domínio em desenvolvimento de ferramentas internas, automações, pipelines de mídia, coleta de dados, integrações com APIs e soluções orientadas a produtividade.

Também venho ampliando bastante meu repertório em frontend e desktop apps com React, TypeScript, Tailwind e Electron quando o produto pede interface mais polida.

## Especialidades

- automações de navegador e web scraping com Selenium, Playwright, Patchright e Camoufox
- projetos de IA com PyTorch, YOLO, OpenCV e OCR
- ferramentas para processamento de vídeo, áudio, imagem e texto
...
<p>
  ...
  <img
    ...
    alt="Top Languages"
    height="190"
    src="https://my-status-lucas-projects-383d7e29.vercel.app/api/top-langs/?username=Lucas7721&theme=dark&layout=compact&custom_title=Tecnologias&langs_count=10"
  />
</p>
...
<p align="center">
  <strong>Domino ferramentas voltadas a automação, dados, IA aplicada e desenvolvimento backend com foco em Python.</strong>
</p>
